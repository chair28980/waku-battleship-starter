      ...
      <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
        ...
        <div>
          <button
            ...
            onClick={() => {
              router.push(
                `/room/${generateThreeDigitNumber()}?username=${username}`
              );
            }}
          >
            Create a new room
        ...
        <div className="flex flex-col items-center">
          ...
          <button
            className={`mt-2 px-4 py-2 rounded-md text-white font-bold ${
              !Boolean(room) || !Boolean(username)
                ? "bg-gray-400 cursor-not-allowed"
            ...
            onClick={() => {
              router.push(
                `/join/${generateThreeDigitNumber()}?username=${username}`
              );
            }}
          >
            Join this room
